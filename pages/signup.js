    ...
    <>
      ...
      <div className={styles.signupmain}>
        <div className={styles.signupform}>
          ...
          <div >
            <form className={styles.signupformfield}>
              ...
              <div className={styles.iconfield}>
                ...
                <div className={styles.iconfieldtext} style={{ width: '90%' }}>
                  <input type="Email" className={styles['form-control']} placeholder="Email Address" />
                </div>
              </div>
              <div className={styles.iconfield}>
                <div class="" style={{ width: '10%' }}>
              ...
              <div className={styles.iconfield}>
                ...
                <div className={styles.iconfieldtext} style={{ width: '90%' }}>
                  <input type="Password" className={styles['form-control']} placeholder="Confirm Password" />
                </div>
              </div>
